  ...
  return (
    <div ref={ref} className="relative">
      <button
        ...
        className="flex items-center gap-1.5 px-2 py-1 rounded-md hover:bg-slate-100 transition-colors duration-150 group"
      >
        {/* Provider badge */}
        <span
      ...
      {open && (
        <div className="absolute left-0 top-full mt-1 bg-white rounded-xl border border-slate-200 shadow-xl z-50 w-64 py-1 animate-slide-up">
                    ...
                    {provider.models.map((m) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          {m.contextWindow && (
                            <span className="text-[10px] text-slate-300 font-data">
                              {m.contextWindow}
                            </span>
                          )}
                          {active && <span className="text-amber-500 text-[10px]">●</span>}
                        </button>
                      );
                    })}
                  </div>
